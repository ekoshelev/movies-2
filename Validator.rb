...
def initializeVariables #Initializes the variables
  @accurate=0
  @offbyone=0
  @offbytwo=0
  @offbythree=0
...
def findMean #Class to find the mean
  prediction=0
  @alldata.each {|user|
...
def findStdev #Find standard deviation
  $i = 0
  until $i > @offbyone  do
 ...
 @stdev=Math.sqrt(@stdev)
  ...
  def printStats #Method to print the statistics
    puts "The mean is #{@mean}."
    puts "The stdev is #{@stdev}."
